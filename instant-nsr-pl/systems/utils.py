...
def update_module_step(m, epoch, global_step):
    """
    Update the step of the model if it has the attribute `update_step`.
    Args:
        m (nn.Module): The model to update.
        epoch (int): The number of epochs run.
        global_step (int): The number of optimizer steps taken
    """
